...
const manifest: LayoutManifest = {
  ...
  contentSchemas: [
    ...
    },
    {
      ...
      defaultEnabled: false, searchable: false, singleton: true,
      itemSchema: [
        { $formkit: "audioUpload", name: "audioUrl", label: "Voice Sample", description: "Upload or record a voice sample for text-to-speech" },
        { $formkit: "textarea", name: "description", label: "Description", placeholder: "Optional notes about this voice sample..." },
      ],
      newItem: () => ({ audioUrl: "", description: "" }),
      itemLabel: (i: any) => i.audioUrl ? "Voice configured" : "No voice set",
      itemSublabel: (i: any) => i.description || "Configure TTS voice sample",
    },
  ],
  schema: [
    {
